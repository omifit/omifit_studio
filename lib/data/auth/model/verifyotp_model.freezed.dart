...
abstract class $VerifyOtpResCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? success, int? status, String? message, Body? body});
...
class _$VerifyOtpResImpl implements _VerifyOtpRes {
  const _$VerifyOtpResImpl(
      {this.success, this.status, this.message, this.body});
  ...
  @override
  String toString() {
    return 'VerifyOtpRes(success: $success, status: $status, message: $message, body: $body)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, success, status, message, body);
