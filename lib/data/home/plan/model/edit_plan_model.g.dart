...
_$EditPlanReqImpl _$$EditPlanReqImplFromJson(Map<String, dynamic> json) =>
    _$EditPlanReqImpl(
...
Map<String, dynamic> _$$EditPlanReqImplToJson(_$EditPlanReqImpl instance) =>
    <String, dynamic>{
      'name': instance.name,
...
_$EditPlanResImpl _$$EditPlanResImplFromJson(Map<String, dynamic> json) =>
    _$EditPlanResImpl(
...
Map<String, dynamic> _$$EditPlanResImplToJson(_$EditPlanResImpl instance) =>
    <String, dynamic>{
