...
abstract class GuidanceRepo {
  Future<Either<ApiException, CreatePlaylistRes>> createPlaylist(CreatePlaylistReq req);
  Future<Either<ApiException, DeletePlaylistRes>> deletePlaylist(String playlistid);
  Future<Either<ApiException, EditPlaylistRes>> editPlaylist(EditPlaylistReq req);
  Future<Either<ApiException, GetPlaylistRes>> getplaylist();
  Future<Either<ApiException, GetPlaylistDetailsRes>> getplaylistDetails(String playlistid);
  ...
  Future<Either<ApiException, EditDocumentRes>> editDocument(EditDocumentReq req);
}
