...
class DesktopGuidanceView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DesktopGuidanceView> createState() =>
      _DesktopGuidanceViewState();
}

class _DesktopGuidanceViewState extends ConsumerState<DesktopGuidanceView> {
  @override
  void initState() {
  ...
  void _getdata() {
    ref.read(guidanceViewModelProvider).getPlaylist(context);
  }
