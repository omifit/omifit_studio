...
mixin _$RegisterReq {
  ...
  LocationReq? get location => throw _privateConstructorUsedError;
...
abstract class $RegisterReqCopyWith<$Res> {
  ...
  $LocationReqCopyWith<$Res>? get location;
}
...
class _$RegisterReqCopyWithImpl<$Res, $Val extends RegisterReq>
  ...
  $LocationReqCopyWith<$Res>? get location {
    ...
    return $LocationReqCopyWith<$Res>(_value.location!, (value) {
...
class _$RegisterReqImpl implements _RegisterReq {
  ...
  @override
  final LocationReq? location;
  @override
  final String? otp;

  @override
  String toString() {
    return 'RegisterReq(name: $name, phoneNumber: $phoneNumber, dateOfBirth: $dateOfBirth, gender: $gender, profession: $profession, profileImage: $profileImage, address: $address, location: $location, otp: $otp)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, name, phoneNumber, dateOfBirth,
      gender, profession, profileImage, address, location, otp);
...
/// @nodoc
@JsonSerializable()
class _$LocationReqImpl implements _LocationReq {
  const _$LocationReqImpl({this.latitude, this.longitude});
  ...
  @override
  String toString() {
    return 'LocationReq(latitude: $latitude, longitude: $longitude)';
  }
...
abstract class _LocationReq implements LocationReq {
  const factory _LocationReq(
      {final double? latitude, final double? longitude}) = _$LocationReqImpl;
